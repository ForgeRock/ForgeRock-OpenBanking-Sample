 ...
 *
 */
package com.forgerock.openbanking.sample.tpp.api.accounts;
...
public class AccountRequestsController implements AccountRequests {
    ...
    @Autowired
    private com.forgerock.openbanking.sample.tpp.services.aspsp.rs.RSAccountAPIService RSAccountAPIService;
    @Autowired
